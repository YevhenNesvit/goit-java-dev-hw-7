...
<html>
    ...
    <body>
        ...
        <form method="post" class="center">
            <label for="skillId">Please, enter skill_id of skill to update:</label><br>
            <input type="text" id="skillId" name="skillId"><br>
            <label for="skillName">name of skill to update:</label><br>
            <input type="text" id="skillName" name="skillName"><br>
            <label for="skillLevel">skill-level of skill to update:</label><br>
